...
from modules.nn.modelsRecAttention_v2 import ModelWrapper
...
param_grid = {'noise_drop':[[0.1, 0.2, 0.2], [0.3, 0.2, 0.2], [0.4, 0.3, 0.4]],
              'attention_heads':[1, 5, 10], 'recurrent_steps':[3, 7], 'encoder_size':[100, 200], 'encoder_layers':[2, 4]}
...
for params in grid:
    ...
    config['attention_heads'] = params['attention_heads']
    config['recurrent_steps'] = params['recurrent_steps']
